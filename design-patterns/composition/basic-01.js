...
console.log(wordsUsed) // => [ 'the', 'quick', 'brown', 'fox', 'jumped', 'fence' ]​​​​​

let wordsUsed2 = unique(words(text))
console.log(wordsUsed2) // => [ 'the', 'quick', 'brown', 'fox', 'jumped', 'fence' ]​

let uniqueWords = (str) => unique(words(text))
let wordsUsed3 = uniqueWords(text)
console.log(wordsUsed3) // => [ 'the', 'quick', 'brown', 'fox', 'jumped', 'fence' ]​
